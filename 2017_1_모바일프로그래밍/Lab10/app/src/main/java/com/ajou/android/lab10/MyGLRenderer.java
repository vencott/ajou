...
//						+ "uniform mat4 u_MVMatrix;       \n"
						...
						+ "void main()                    \n"
						+ "{                              \n"
						+ "   vec3 worldVertex = vec3(u_M * a_Position);              \n"
						+ "   vec3 worldNormal = vec3(u_M * vec4(a_Normal, 0.0));     \n"
						+ "   float distance = length(u_LightPos - worldVertex);             \n"
						+ "   vec3 lightVector = normalize(u_LightPos - worldVertex);        \n"
						+ "   float diffuse = max(dot(worldNormal, lightVector), 0.1);       \n"
						+ "   diffuse = diffuse * (15.0 / (1.0 + (0.25 * distance * distance)));  \n"
	...
	public void setCubeColorDataToRed() {
		mCubeColors.put(redCubeColorData);
	}

	public void setCubeColorDataToGreen() {
		mCubeColors.put(greenCubeColorData);
	}

	public void setCubeColorDataToBlue() {
		mCubeColors.put(blueCubeColorData);
	}
}
